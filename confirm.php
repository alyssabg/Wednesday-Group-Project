            ...
            <div class="row">
               ...
               <!-- </span>-->
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            <td class="col-md-9"></h4><em>Product Item</em></h4></td>
                            <td class="col-md-1" style="text-align: center"> 3 </td>
                            <td class="col-md-1 text-center">$4.87</td>
                            <td class="col-md-1 text-center">$14.61</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="color:#d824c9;"><h4><strong>$21.55</strong></h4></td>
                        </tr>
                    </tbody>
                </table>
